...
onMounted(async () => {
  nextTick(async () => {
    if(localStorage.key("solana")) {
      console.log(localStorage.getItem('solana').walletSelection)
      // if(localStorage.getItem('solana').walletSelection){
      //   selectWallet(localStorage.getItem('solana').walletSelection)
      // }
    }
