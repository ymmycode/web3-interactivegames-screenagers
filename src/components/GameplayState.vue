<template>
  ...
  <div class="absolute w-full h-full top-0 left-0 bg-black bg-opacity-70 z-10 flex justify-center items-center">
    <div class="text-score-constant lato font-bold text-primary-1 !tracking-widest opacity-0 -translate-y-[2vh] uppercase transition-[transform,opacity] duration-500"
    :class="[
